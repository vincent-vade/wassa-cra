...
export type CreateFreelance = paths["/api/rest/freelances"]["post"]["requestBody"]["content"]["application/json"];
export type Freelances = paths["/api/rest/freelances"]["get"]["responses"]["200"]["content"]["application/json"]["freelances"];
