...
const EmptyRow = () => {
	return (
		<tr>
			...
			>
				Please select a project and add some task(s)...
			</td>
		</tr>
	);
};
...
const arraySum = (arr: number[]) =>
	Array.isArray(arr) ? arr.reduce(add, 0) : 0;
...
export const Timesheet = ({
	...
	const [timesheetTotalRow, setTimesheetTotalRow] = useState<number[]>(
		calculateRowTotalV2(month, tasks)
	);
