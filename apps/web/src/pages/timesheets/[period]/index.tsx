import { TimesheetsByPeriod} from "~/lib/client";
...
export default function TimesheetPage({ year, month, timesheet }: { year: string, month: string, timesheet: Record<string, TimesheetEdit>[] }) {
	...
	return (
		<>
			...
			<table>
				...
				<tbody>
					{
						Object.entries(timesheet).length === 0 ? <EmptyRow />  : Object.entries(timesheet).map(([projectTaskId, _task]) => {
