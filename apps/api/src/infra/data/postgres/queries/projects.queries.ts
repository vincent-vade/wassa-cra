 ...
 * ```
 */
export const findAllProjects = new PreparedQuery<
	IFindAllProjectsParams,
	IFindAllProjectsResult
>(findAllProjectsIR);
...
const findProjectByIdIR: any = {
	...
	statement: 'SELECT * FROM "projects" WHERE "id" = :projectId',
};
 ...
 * ```
 */
export const findProjectById = new PreparedQuery<
	IFindProjectByIdParams,
	IFindProjectByIdResult
>(findProjectByIdIR);
...
const findProjectByNameIR: any = {
	usedParamSet: { projectName: true },
	params: [
		{
			name: "projectName",
			required: false,
	...
	statement: 'SELECT * FROM "projects" WHERE "name" = :projectName',
};
 ...
 * ```
 */
export const findProjectByName = new PreparedQuery<
	IFindProjectByNameParams,
	IFindProjectByNameResult
>(findProjectByNameIR);
...
const createProjectIR: any = {
	usedParamSet: { project: true },
	params: [
		{
			name: "project",
			required: false,
 ...
 * ```
 */
export const createProject = new PreparedQuery<
...
const deleteProjectIR: any = {
	...
	statement: 'DELETE FROM "projects" WHERE "id" = :projectId RETURNING *',
};
 ...
 * ```
 */
export const deleteProject = new PreparedQuery<
